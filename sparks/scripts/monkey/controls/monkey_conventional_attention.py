...
from sparks.models.transformer import TransformerEncoder
...
if __name__ == "__main__":
    ...
    parser.add_argument('--smooth', action='store_false', default=True)


    args = parser.parse_args()

    make_res_folder('monkey_reaching_control_attention', os.getcwd(), args)
    ...
    (train_dataset, test_dataset,
     train_dl, test_dl) = make_monkey_reaching_dataset(os.path.join(args.home, "datasets/000127/sub-Han/"),
                                                       ...
                                                       mode='prediction')
    # Make networks
    encoding_network = TransformerEncoder(n_inputs=train_dataset.x_shape,
